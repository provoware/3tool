...
BASE_COMPONENT_STYLE = (
    ...
    "QPushButton[dashboardStatusCard='true']{text-align:left;font-weight:700;line-height:1.35;min-height:4.4em;} QFrame[actionTile='true']:focus-within{border:2px solid #ffbf00;} QPushButton[actionButton='true']{letter-spacing:0.01em;} "
    "QFrame[feedbackKind='error']{border:2px solid #b42318;border-radius:0.6em;background:#fef3f2;} "
...
def _build_theme_css(tokens: Dict[str, str]) -> str:
    ...
    return (
        ...
        f"QPushButton[buttonRole='secondary']:hover{{background-color:{tokens['button_hover']};}} "
        f"QPushButton[buttonRole='support']:hover{{background-color:{tokens['button_hover']};}} "
        f"QPushButton[buttonRole='danger']{{background-color:{tokens['preview_danger_bg']};color:{tokens['preview_danger_fg']};border:2px solid {tokens['preview_danger_border']};}} "
        f"QPushButton[buttonRole='danger']:hover{{background-color:{tokens['button_hover']};}} "
        f"QPushButton[buttonRole='danger']:focus{{border:2px solid {tokens['focus_color']};}} "
